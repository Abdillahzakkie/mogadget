    ...
    <footer style={foot}>
      <div style={wrap}>
        <div>
          ...
          <p style={muted}>New &amp; pre-owned gadgets, graded and tested. Browse, then chat to order.</p>
        </div>
        <div style={col}>
...
const foot = { borderTop: "1px solid rgba(20,21,24,.08)", marginTop: 48, background: "var(--paper)" };
const wrap = {
  maxWidth: 1240,
  margin: "0 auto",
  padding: "32px 20px",
...
const h = { font: "600 13px var(--font-body)", letterSpacing: ".06em", textTransform: "uppercase" as const };
